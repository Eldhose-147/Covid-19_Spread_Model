# IMP(In this code we start with the assumption that covid has started in 1st January 2021)
#IMP(The starting condition is thus Susceptible=Population, Infected=0, Resistant=0 )
#Importing libraries
import pandas as pd
import numpy as np
...
Ind_con=Cov_con.loc['India']['1/1/21':'8/4/21']-Cov_con.loc['India']['1/1/21']
Ind_death=Cov_death.loc['India']['1/1/21':'8/4/21']-Cov_death.loc['India']['1/1/21']
Ind_rec=Cov_rec.loc['India']['1/1/21':'8/4/21']-Cov_rec.loc['India']['1/1/21']
...
Avg_Beta=np.average(Beta[110:150])
Avg_Gamma=np.average(Gamma[110:150])
print(Avg_Beta)
#Kermack-McKendrick model
def SIR_model(beta,gamma,N):
    ...
    p0 = [Susceptible['1/1/21']-1, Infected['1/1/21']+1, Resistant['1/1/21']]
    #number of days
    n = elapsed_time
    # time points
...
S,I,R=SIR_model(Avg_Beta,Avg_Gamma,Pop)
